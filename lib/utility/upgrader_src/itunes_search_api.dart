...
class ITunesSearchAPI {
  ...
  Future<Map?> lookupByBundleId(String bundleId,
    ...
    if (debugEnabled) {
      log('upgrader: download: $url');
    }

    try {
      final response = await client!.get(Uri.parse(url));
      if (debugEnabled) {
        log('upgrader: response statusCode: ${response.statusCode}');
      }

      final decodedResults = _decodeResults(response.body);
      return decodedResults;
    } catch (e) {
      log('upgrader: lookupByBundleId exception: $e');
      return null;
    }
  }
...
class ITunesResults {
  ...
  static String? bundleId(Map response) {
    ...
    try {
      ...
      log('upgrader.ITunesResults.bundleId: $e');
    }
    return value;
  }
  ...
  static String? currency(Map response) {
    ...
    try {
      ...
      log('upgrader.ITunesResults.currency: $e');
    }
    return value;
  }
  ...
  static String? releaseNotes(Map response) {
    ...
    try {
      ...
      log('upgrader.ITunesResults.releaseNotes: $e');
    }
    return value;
  }
  ...
  static String? trackViewUrl(Map response) {
    ...
    try {
      ...
      log('upgrader.ITunesResults.trackViewUrl: $e');
    }
    return value;
  }
  ...
  static String? version(Map response) {
    ...
    try {
      ...
      log('upgrader.ITunesResults.version: $e');
    }
    return value;
  }
}