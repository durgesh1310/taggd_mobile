...
class UpgradeCard extends UpgradeBase {
  ...
  Widget build(BuildContext context, UpgradeBaseState state) {
    if (Upgrader().debugLogging) {
      log('UpgradeCard: build UpgradeCard');
    }
        ...
        builder: (BuildContext context, AsyncSnapshot<bool> processed) {
          if (processed.connectionState == ConnectionState.done &&
            ...
            if (Upgrader().shouldDisplayUpgrade()) {
              ...
              if (Upgrader().debugLogging) {
                log('UpgradeCard: will display');
                log('UpgradeCard: showDialog title: $title');
                log('UpgradeCard: showDialog message: $message');
                log(
                    'UpgradeCard: shouldDisplayReleaseNotes: $shouldDisplayReleaseNotes');

                log('UpgradeCard: showDialog releaseNotes: $releaseNotes');
              }
              ...
              if (Upgrader().debugLogging) {
                log('UpgradeCard: will not display');
              }
            }
          }
